...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $catfood_name = $conn->real_escape_string($_POST['catfood']); // Ensure this value is escaped
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $image = $targetFile;
            $sql = "INSERT INTO food (foodname, description, image, price, catfood)
                    VALUES ('$foodname', '$description', '$image', '$price', '$catfood_name')";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
    Name: <input type="text" name="foodname" required><br>
