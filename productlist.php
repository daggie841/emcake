...
if (isset($_POST['edit_id'])) {
    ...
    $edit_sql = "UPDATE food SET foodname=?, image=?, price=?, description=?, catfood=? WHERE id=?";
    $stmt = $conn->prepare($edit_sql);
    $stmt->bind_param("ssdsss", $edit_foodname, $edit_image, $edit_price, $edit_description, $edit_catfood, $edit_id);
    if ($stmt->execute()) {
...
$sql = "SELECT id, foodname, image, price, description, catfood FROM food";
